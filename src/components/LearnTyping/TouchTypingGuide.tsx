      ...
      <div className="max-w-4xl mx-auto p-6 space-y-8">
        ...
        <div className="shadow-lg p-6 rounded-lg bg-white">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            keyboard, and your fingers learn the location of the keyboard
            through practicing regularly and gaining muscle memory to eventually
            build up speed whilst typing.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg mb-4">
                <p className="text-gray-700 leading-relaxed">
                  ...
                  anchor point and reference position for reaching all other
                  keys efficiently.
                </p>
              </div>
