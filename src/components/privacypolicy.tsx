  ...
  return (
    <div>
      <div className="font-sans bg-gray-100 p-6 text-gray-900 ">
        ...
        <h2 className="text-blue-400 text-xl font-semibold">Log Files</h2>
        <p>
          Typing Scholar follows a standard procedure of using log files. These
        ...
        <p>
          ...
          advertising partners of Typing Scholar.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Typing Scholar, which are sent
        ...
        <p>
          Note that Typing Scholar has no access to or control over these
        ...
        <p>
          Typing Scholar's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          Typing Scholar does not knowingly collect any Personal Identifiable
        ...
        <p>
          ...
          shared and/or collect in Typing Scholar. This policy is not applicable
          to any information collected offline or via channels other than this
          website.
        </p>
        <h2 className="text-blue-400 text-xl font-semibold">Consent</h2>
        <p>
